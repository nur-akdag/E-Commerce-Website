      ...
      <section className="w-full max-w-[1290px] mx-auto px-5 md:px-10 py-6 relative">
        <div className="w-full bg-gradient-to-r from-[#96E9FB] to-[#ABECD6] rounded-[32px] md:rounded-[40px] relative flex flex-col lg:flex-row items-center lg:h-[680px] overflow-hidden lg:overflow-visible">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left z-20 flex-1 px-6 pt-16 pb-0 md:py-15 md:px-15 lg:p-0 lg:pl-35 w-full">
            <h5 className="text-[#2A7CC7] font-bold tracking-widest text-sm md:text-medium lg:text-base mb-4">SUMMER 2020</h5>
            <h1 className="text-4xl md:text-[40px] lg:text-[58px] font-bold text-[#252B42] leading-tight md:leading-tight lg:leading-[58px] tracking-tight mb-4 md:mb-5">NEW COLLECTION</h1>
            <p className="text-lg md:text-base lg:text-[20px] text-[#737373] max-w-[295px] md:max-w-[320px] lg:max-w-[350px] font-medium leading-relaxed mb-6 md:mb-6">We know how large objects will act, but things on a small scale.</p>
            
            
            <Link 
              to="/shop" 
              className="inline-block bg-[#23A6F0] text-white px-8 py-3 md:px-6 md:py-3 lg:px-10 lg:py-4 rounded-[5px] font-bold text-lg md:text-base lg:text-[24px] tracking-wider uppercase hover:bg-[#1a8bc7] transition-all shadow-md cursor-pointer text-center"
            >
              SHOP NOW
            </Link>
          ...
          <div className="relative w-full max-w-[350px] sm:max-w-[400px] md:max-w-[450px] lg:max-w-none aspect-square md:aspect-auto md:h-[450px] lg:h-[750px] lg:absolute lg:bottom-0 lg:-right-[70px] lg:w-[750px] flex justify-center items-end z-10 pointer-events-none mx-auto mt-10 md:mt-0">
            ...
            <img src={heroVisual} alt="New Collection Girl" className="relative z-20 h-[145%] md:h-[120%] lg:h-[100%] object-contain object-bottom pointer-events-auto select-none" />
          </div>
        </div>
      </section>
          ...
          <>
            <div className="flex flex-row flex-wrap justify-center gap-x-6 gap-y-16 w-full">
              {[...productList]
                ...
                <div key={product.id} className="flex flex-col w-full sm:w-[calc(50%-12px)] md:w-[calc(33.333%-16px)] lg:w-[calc(20%-19.2px)] bg-white cursor-pointer group justify-between">
                  ...
                  <div className="flex flex-col items-center text-center gap-2 px-2 flex-grow justify-between">
                    <div className="flex flex-col items-center gap-1 w-full">
                      {/* Ürün ismi ne olursa olsun hep 1 satırlık yer kaplar */}
