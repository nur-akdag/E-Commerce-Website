...
export default function HomePage() {
  ...
  const totalSimulatedProducts = 20;
  ...
  return (
    <div className="w-full flex flex-col bg-white font-['Montserrat'] overflow-x-hidden">
      ...
      {/* ================= SECTION 1: HERO SECTION (Max 1290px) ================= */}
      <section className="w-full max-w-[1290px] mx-auto px-5 md:px-10 py-6 relative">
        <div className="w-full bg-gradient-to-r from-[#96E9FB] to-[#ABECD6] rounded-[32px] md:rounded-[40px] relative flex flex-col lg:flex-row items-center lg:h-[680px] overflow-hidden lg:overflow-visible">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left z-20 flex-1 px-6 pt-16 pb-0 md:py-15 md:px-15 lg:p-0 lg:pl-35 w-full">
            <h5 className="text-[#2A7CC7] font-bold tracking-widest text-sm md:text-medium lg:text-base mb-4">
              SUMMER 2020
            </h5>
            
            <h1 className="text-4xl md:text-[40px] lg:text-[58px] font-bold text-[#252B42] leading-tight md:leading-tight lg:leading-[58px] tracking-tight mb-4 md:mb-5">
              NEW COLLECTION
            </h1>
            
            <p className="text-lg md:text-base lg:text-[20px] text-[#737373] max-w-[295px] md:max-w-[320px] lg:max-w-[350px] font-medium leading-relaxed mb-6 md:mb-6">
              We know how large objects will act, but things on a small scale.
            </p>
            <button className="bg-[#23A6F0] text-white px-8 py-3 md:px-6 md:py-3 lg:px-10 lg:py-4 rounded-[5px] font-bold text-lg md:text-base lg:text-[24px] tracking-wider uppercase hover:bg-[#1a8bc7] transition-all shadow-md cursor-pointer">
              SHOP NOW
            </button>
          </div>

          {/* GÖRSEL VE YUVARLAK FON */}
      ...
      {/* ================= SECTION 2: CLIENTS LOGOS (Max 1050px) ================= */}
      ...
      {/* ================= SECTION 3: TOP PRODUCT OF THE WEEK (Max 1185px) ================= */}
      <section className="w-full max-w-[1185px] mx-auto px-8 lg:px-0 py-12">
        <div className="flex flex-col md:flex-row gap-4 w-full h-auto md:h-[600px]">
          ...
          {/* SOL BÜYÜK KART */}
          <div className="relative w-full md:w-1/2 h-[450px] md:h-full bg-gray-200 overflow-hidden group">
            <img src="https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?q=80&w=800" alt="Top Product" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
            <div className="absolute bottom-0 left-0 w-full md:w-[70%] bg-[#2D8BC0BF]/90 p-10 md:p-8 flex flex-col gap-6 text-white">
              <h3 className="text-[22px] md:text-3xl font-bold leading-tight">Top Product<br/>Of the Week</h3>
              <button className="border border-white rounded-[5px] px-8 py-4 w-max font-bold text-sm tracking-widest hover:bg-white hover:text-[#23A6F0] transition-colors cursor-pointer">EXPLORE ITEMS</button>
            </div>
          </div>

          {/* SAĞ KARTLAR */}
          <div className="flex flex-col w-full md:w-1/2 gap-4 h-[700px] md:h-full">
            <div className="relative w-full flex-1 bg-gray-300 overflow-hidden group">
              <img src="https://images.unsplash.com/photo-1434389678369-18342cb31124?q=80&w=800" alt="Top Product 2" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
              <div className="absolute bottom-0 left-0 w-full md:w-[70%] bg-[#2D8BC0BF]/90 p-10 md:p-6 flex flex-col gap-4 text-white">
                <h4 className="text-[22px] md:text-2xl font-bold">Top Product<br/>Of the Week</h4>
                <button className="border border-white rounded-[5px] px-8 py-4 w-max font-bold text-sm tracking-widest hover:bg-white hover:text-[#23A6F0] transition-colors cursor-pointer">EXPLORE ITEMS</button>
              </div>
            </div>
            <div className="relative w-full flex-1 bg-gray-400 overflow-hidden group">
              <img src="https://images.unsplash.com/photo-1529139574466-a303027c1d8b?q=80&w=800" alt="Top Product 3" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
              <div className="absolute bottom-0 left-0 w-full md:w-[70%] bg-[#2D8BC0BF]/90 p-10 md:p-6 flex flex-col gap-4 text-white">
                <h4 className="text-[22px] md:text-2xl font-bold">Top Product<br/>Of the Week</h4>
                <button className="border border-white rounded-[5px] px-8 py-4 w-max font-bold text-sm tracking-widest hover:bg-white hover:text-[#23A6F0] transition-colors cursor-pointer">EXPLORE ITEMS</button>
              </div>
      ...
      {/* ================= SECTION 4: BESTSELLER PRODUCTS (Max 1124px) ================= */}
      <section className="w-full max-w-[1124px] mx-auto px-8 lg:px-0 py-16 flex flex-col items-center">
        ...
        <div className="flex flex-row flex-wrap justify-center gap-x-6 gap-y-16 w-full">
          {Array.from({ length: totalSimulatedProducts }).slice(0, visibleProducts).map((_, index) => (
            <div key={index} className="flex flex-col w-full sm:w-[calc(50%-12px)] md:w-[calc(33.333%-16px)] lg:w-[calc(20%-19.2px)] bg-white cursor-pointer group">
              <div className="w-full aspect-[3/4] bg-gray-100 overflow-hidden mb-6">
                <img src={`https://picsum.photos/seed/${index + 100}/400/600`} alt="Product" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
              </div>
              <div className="flex flex-col items-center text-center gap-3">
                <h5 className="font-bold text-[#252B42] text-base">Graphic Design</h5>
        ...
        {visibleProducts < totalSimulatedProducts && (
          <button 
            onClick={handleLoadMore}
            className="mt-20 border border-[#23A6F0] text-[#23A6F0] px-10 py-4 rounded-[5px] font-bold text-sm tracking-wider uppercase hover:bg-[#23A6F0] hover:text-white transition-colors cursor-pointer"
          >
            LOAD MORE PRODUCTS
          </button>
        )}
      ...
      {/* ================= SECTION 5: WE LOVE WHAT WE DO (Max 1050px) ================= */}
      <section className="w-full max-w-[1050px] mx-auto px-8 lg:px-0 py-16">
        <div className="flex flex-col lg:flex-row items-start lg:items-center gap-12 lg:gap-24 w-full">
          ...
          {/* TEXT KISMI */}
          <div className="flex flex-col max-w-[260px] items-start text-left w-full lg:w-1/2 gap-4 lg:gap-6 order-1 lg:order-2">
            ...
            <p className="text-sm lg:text-base text-[#737373] leading-relaxed mt-2">
          ...
          <div className="flex flex-row gap-4 w-full lg:w-1/2 h-[450px] md:h-[500px] order-2 lg:order-1">
            <div className="flex-1 overflow-hidden">
              <img src="https://images.unsplash.com/photo-1517841905240-472988babdf9?q=80&w=600" alt="Girl with glasses" className="w-full h-full object-cover" />
            </div>
            <div className="flex-1 overflow-hidden">
              <img src="https://images.unsplash.com/photo-1529139574466-a303027c1d8b?q=80&w=600" alt="Girl in yellow" className="w-full h-full object-cover" />
            </div>
          </div>
      ...
      {/* ================= SECTION 6: THE BEST SERVICES (Max 1050px) ================= */}
      ...
      {/* ================= SECTION 7: FEATURED POSTS (BLOG) (Max 1050px) ================= */}
        ...
        <div className="flex flex-col lg:flex-row justify-center items-stretch gap-8 w-full">
          ...
          <div className="flex flex-col sm:flex-row w-full lg:w-1/2 bg-white hover:shadow-md transition-shadow duration-300 group border border-[#EEEEEE]">
            ...
            <div className="flex flex-col justify-center p-6 sm:p-8 w-full sm:w-[55%] gap-4">
              <div className="flex gap-4 text-xs font-normal text-[#737373]">
                <span className="text-[#8EC2F2]">Google</span><span>Trending</span><span>New</span>
              </div>
              ...
              <div className="flex items-center gap-2 font-bold text-sm text-[#737373] mt-2 hover:text-[#23A6F0] transition-colors cursor-pointer">
                Learn More <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#23A6F0" strokeWidth="2"><polyline points="9 18 15 12 9 6"/></svg>
              </div>
            </div>
          </div>
